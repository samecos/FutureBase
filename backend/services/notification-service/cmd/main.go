...
import (
	...
	"github.com/archplatform/notification-service/internal/config"
	"github.com/archplatform/notification-service/internal/handler"
...
func main() {
	...
	// Create handler
	h := handler.NewHandler(postgresStorage, wsManager, emailSender)
