...
import (
	...
	"github.com/archplatform/geometry-service/pkg/server"
	"go.uber.org/zap"
...
func main() {
	...
	logger.Info("Starting geometry service",
	...
	// Create server
	srv, err := server.NewGeometryServer(cfg, logger)
	if err != nil {
	...
	wg.Wait()
	logger.Info("Geometry service stopped")
}
