...
import (
	...
	"github.com/archplatform/file-service/internal/handler"
...
func main() {
	...
	thumbGen := thumbnail.NewGenerator(
		...
		cfg.Thumbnails.Format,
	)

	// Create handler
	h := handler.NewHandler(postgresStorage, minioClient, thumbGen)
